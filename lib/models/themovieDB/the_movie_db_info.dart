...
class MovieInfo {
  ...
  MovieInfo({this.id, this.title, this.overview, this.status, this.voteAverage, this.releaseDate, this.backdropPath, this.runTime, this.genreInfoList});
...
class OnTvInfo{
  ...
  OnTvInfo({this.id, this.title, this.overview, this.status, this.voteAverage, this.releaseDate, this.backdropPath, this.runTime, this.genreInfoList});
